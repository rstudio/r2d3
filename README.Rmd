...
<img src="tools/README/r2d3-hex.svg" width=180 align="right" style="margin-right: 20px;"/>
...
The above `barchart.js` script can be rendered from R by calling `r2d3` as follows:
