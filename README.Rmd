...
Note that we provide data for the script using the `data` argument. This data is then automatically made available to the D3 script. There are a number of other special variables available within D3 scripts, including:
