...
With **r2d3**, you can bind data from R to D3 visualizations like the ones found on [D3 Gallery](https://github.com/d3/d3/wiki/Gallery), [Blocks](https://bl.ocks.org/), and [VIDA](https://vida.io/explore): 
