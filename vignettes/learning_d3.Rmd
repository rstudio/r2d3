...
<img src="images/d3_book.png" width=130 align="right" style="margin-left: 20px"/>
...
On the other hand with **r2d3**, these variables are *provided automatically* so do not need to be created. Here is some code you'll typically see in D3 examples:
