...
If you don't like the default JSON conversion provided for `data`, you can write your own function that uses [jsonlite](https://cran.r-project.org/web/packages/jsonlite/index.html) to perform a custom conversion. For example:
