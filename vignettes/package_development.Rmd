...
The **r2d3** package includes an `html_dependency_d3()` function which enables you to use multiple incompatible versions of D3 within a single document or application. This is accomplished by renaming the global D3 object with a version suffix. So when using `html_dependency_d3()` the following are the correct references to D3:
...
htmlwidgets::createWidget(
  ...
  height = height,
  package = "mypackage",
  dependencies = r2d3::html_dependency_d3(version = "4")
)
```
