...
Notice that **r2d3** assigns **background** to the `background` style and **foreground** to the `fill` and `color` styles. Other environments hosting **r2d3** can set the `r2d3.theme` option to customize the value of the `theme` object.
