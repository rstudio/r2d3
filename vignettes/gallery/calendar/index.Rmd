...
r2d3(data = read.csv("dji.csv"), d3_version = 4, container = "div", height = 1300, script = "calendar.js")
```

```{r, echo=FALSE}
r2d3(data = read.csv("dji.csv"), d3_version = 4, container = "div", height = 1300, script = "calendar.js", width="100%")
```
