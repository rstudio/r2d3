...
```{r, echo=FALSE}
r2d3(data = read.csv("dji-latest.csv"), d3_version = 4, container = "div", options = list(start = 2006, end = 2011), script = "calendar.js", width="100%")
```
...
```{r, results='asis'}
cat("```js\n")
writeLines(readLines("calendar.js", warn = FALSE))
cat("```\n")
```
