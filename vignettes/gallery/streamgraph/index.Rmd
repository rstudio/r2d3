...
<div id="source-link">
<https://github.com/rstudio/r2d3/tree/master/vignettes/gallery/streamgraph>
</div>
...
r2d3(data=c(), script = "streamgraph.js")
```

```{r, echo=FALSE}
r2d3(data=c(), script = "streamgraph.js", width="100%")
```
...
```{r, results='asis'}
cat("```js\n")
writeLines(readLines("streamgraph.js", warn = FALSE))
cat("```\n")
```
...
$('a.list-group-item[href="../streamgraph/"]').addClass('active');
