...
r2d3(data = read.csv("population.csv"), d3_version = 3, options = list(year = 2000), script = "population.js")
```

```{r, echo=FALSE}
r2d3(data = read.csv("population.csv"), d3_version = 3, options = list(year = 2000), script = "population.js", width="100%")
```
