...
<div id="source-link">
<https://github.com/rstudio/r2d3/tree/master/vignettes/gallery/morley>
</div>
...
r2d3(data = read.csv("morley.csv"), d3_version = 3, container = "div", dependencies = c("box.js"), script = "morley.js")
```

```{r, echo=FALSE}
r2d3(data = read.csv("morley.csv"), d3_version = 3, container = "div", dependencies = c("box.js"), script = "morley.js", width="100%")
```
...
```{r, results='asis'}
cat("```js\n")
writeLines(readLines("morley.js", warn = FALSE))
cat("```\n")
```
...
```{r, results='asis'}
cat("```js\n")
writeLines(readLines("box.js", warn = FALSE))
cat("```\n")
```
...
```{r, results='asis'}
cat("```css\n")
writeLines(readLines("morley.css", warn = FALSE))
cat("```\n")
```
...
$('a.list-group-item[href="../morley/"]').addClass('active');
